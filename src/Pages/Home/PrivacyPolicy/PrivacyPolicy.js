    ...
    <div>
      <div className="py-[3px]">
        <div className="rounded-t-[20px] w-full bg-rose-500 text-primary-content">
          <div className="card-body py-2 items-center text-center">
            <h2 className="card-title text-white">Privacy Policy</h2>
          </div>
        </div>
      </div>
      ...
      <div className="px-2">
        <div>
          <div>
            <p>
              At Blood DonationBD - রক্ত খুঁজুন, one of our main priorities is
              the privacy of our visitors. This Privacy Policy document contains
              types of information that is collected and recorded by Blood
              DonationBD - রক্ত খুঁজুন and how we use it. If you have additional
              ...
              Blood DonationBD - রক্ত খুঁজুন. This policy is not applicable to
        ...
        <div>
          <h1 className="text-center">Information we collect</h1>
        ...
        <div>
          <h1 className="text-center">How we use your information</h1>
        ...
        <div>
          <h1 className="text-center">Log Files</h1>

          <div>
            <p>
              Blood DonationBD - রক্ত খুঁজুন follows a standard procedure of
        ...
        <div>
          <h1 className="text-center">Cookies and Web Beacons</h1>

          <div>
            <p>
              Like any other website, Blood DonationBD - রক্ত খুঁজুন uses
              ...
              visitors' browser type and/or other information. For more general
              information on cookies, please read more on the Cookie Consent
              website.
            </p>
          </div>
        </div>
        <div>
          <h1 className="text-center">Google DoubleClick DART Cookie</h1>
        ...
        <div>
          <h1 className="text-center">Advertising Partners Privacy Policies</h1>

          <div>
            <p>
              You may consult this list to find the Privacy Policy for each of
              the advertising partners of Blood DonationBD - রক্ত খুঁজুন.
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Blood
              DonationBD - রক্ত খুঁজুন, which are sent directly to users'
              ...
              that Blood DonationBD - রক্ত খুঁজুন has no access to or control
              over these cookies that are used by third-party advertisers.
            </p>
          </div>
        </div>
        <div>
          <h1 className="text-center">Third Party Privacy Policies</h1>

          <div>
            <p>
              Blood DonationBD - রক্ত খুঁজুন's Privacy Policy does not apply to
        ...
        <div>
          <h1 className="text-center">GDPR Data Protection Rights</h1>
        ...
        <div>
          <h1 className="text-center">Children's Information</h1>
          ...
          <div>
            <p>
              ...
              activity. Blood DonationBD - রক্ত খুঁজুন does not knowingly
