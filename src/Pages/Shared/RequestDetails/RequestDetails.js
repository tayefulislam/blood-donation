...
const RequestDetails = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center mx-2'>
            ...
            <h1 className='text-center font-semibold text-xl'>Blood Request Details</h1>
            ...
            <div className='mt-5'>
                ...
                <div>
                    ...
                    <div className='flex flex-col justify-center items-center mx-2'>
                        ...
                        <button className='bg-red-500 text-white py-3 px-5 rounded-full' onClick={() => copyURL()}>Copy</button>
                    </div>
